                ...
                <div class="col-7">
                    <div class="table-responsive">
                        <table class="table mb-0 align-items-center">
                            <tbody>
                                <tr v-for="(item, index) in chart.datasets.label" :key="index">
                                    <td>
                                        <div class="px-2 py-0 d-flex">
                                            <span class="badge me-2" :style="{background: backgroundColor[index]}">&nbsp;</span>
                                    ...
                                    <td class="text-sm text-center align-middle">
                                        <span class="text-xs font-weight-bold">{{chart.datasets.data[index]}}</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
