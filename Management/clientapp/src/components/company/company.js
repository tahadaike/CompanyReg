...
export default {
    ...
    methods: {
        ...
        GetInfo(pageNo) {
            ...
            this.$blockUI.Start();
            this.$http
                .GetCompanies(this.pageNo, this.pageSize,this.ReceiptNumber)
                .then((response) => {
                    this.$blockUI.Stop();
        ...
        CahngeLevels(Id) {
            Swal.fire({
                title: "هـل انت متأكد من عملية المطابقة  ؟",
                showDenyButton: true,
                showCancelButton: false,
                confirmButtonText: `تأكيد العملية`,
                denyButtonText: `الغاء العملية`,
                ...
                if (result.isConfirmed) {
                    ...
                    this.$http.CahngeLevels(Id)
                        ...
                        .catch((err) => {
                            this.$blockUI.Stop();
                            this.$helper.ShowMessage('error', 'خطأ بعملية المطابقة', err.response.data);
                        });
                    return;
                }
            });
